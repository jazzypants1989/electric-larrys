...
export default function Links() {
  return (
    <div className="text-center h-full">
      ...
      >
        <ul className="grid grid-cols-2 mx-10 md:mx-auto gap-1 mb-2 text-center text-base md:text-xs text-orange">
          <li className="p-1 font-thin hover:text-Yellow hover:scale-125">
            <Link href="/">Home</Link>
          </li>
          <li className="p-1 font-thin hover:text-Yellow hover:scale-125">
