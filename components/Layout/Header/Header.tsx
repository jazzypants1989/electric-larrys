...
export default function Header() {
  ...
  return (
    <nav
      className="flex h-16 items-center justify-between shadow-md ml-2"
    ...
    >
      ...
      <div>
        ...
        {cartItemsCount > 0 && (
          <span
            onClick={cartClickHandler}
            className="absolute -translate-y-3 lg:-translate-y-1 -translate-x-6 lg:ml-2 rounded-full bg-Green font-extralight hover:bg-orange px-1 text-Black hover:text-Green transition-all duration-500 ease-in-out cursor-pointer"
          >
            {cartItemsCount}
          </span>
        )}
