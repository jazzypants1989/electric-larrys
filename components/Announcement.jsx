  ...
  return (
    <>
      {announcement.isPublished && (
        <div className="animate-dropDown bg-Green flex flex-col justify-center items-center text-blue max-h-fit min-w-screen mx-8 rounded-t-2xl rounded-b-lg px-2 md:mb-1 gap-1 even:bg-orange even:text-Green even:mt-2 even:pb-1">
