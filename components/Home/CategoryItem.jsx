  ...
  return (
    <div className="sm:w-20 sm:h-20 md:w-fit md:h-fit flex flex-col items-center justify-center animate-swoosh">
      ...
      >
        ...
        />
        <h4 className="mt-0 absolute bg-opacity-50 md:bg-opacity-50 bg-orange md:bg-blue p-3 rounded-full text-center drop-shadow md:mt-4 hover:blur-none hover:bg-opacity-100 hover:scale-125 transition-all duration-500 ease-in-out">
          {category}
        </h4>
      </button>
    </div>
