export default function Privacy() {
  return (
    <div>
      <h2 className="text-center text-4xl text-orange drop-shadow">
      ...
      <p className="mb-4 text-center drop-shadow md:text-sm lg:text-lg">
        ...
        Terms and Conditions, which is accessible below on this page, unless
        otherwise defined in this Privacy Policy.
      </p>

      <h2 className="mb-4 text-center text-orange drop-shadow md:text-sm lg:text-lg">
      ...
      <ul className="mb-4 text-center drop-shadow md:text-sm lg:text-lg">
        <li className="mb-4 text-center drop-shadow md:text-sm lg:text-lg">
