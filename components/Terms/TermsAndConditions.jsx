    ...
    <>
      ...
      <body className="text-center">
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          with these Terms of Use; (4) you are not under the age of 13; (5) you
          are not a minor in the jurisdiction in which you reside, or if a
          minor, you have received parental permission to use the Site; (6) you
          will not access the Site through automated or non-human means, whether
          through a bot, script or otherwise; (7) you will not use the Site for
          any illegal or unauthorized purpose; and (8) your use of the Site will
        ...
        <p className="first-letter:text-3xl text-left">
          {" "}
          4. USER REGISTRATION You may be required to register with the Site.
        ...
        <p className="first-letter:text-3xl text-left">
          9. USER GENERATED CONTRIBUTIONS The Site does not offer users to
          submit or post content. We may provide you with the opportunity to
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          Site, you agree that we can use and share such feedback for any
          purpose without compensation to you. We do not assert any ownership
        ...
        <p className="first-letter:text-3xl text-left">
          {" "}
          11. SOCIAL MEDIA As part of the functionality of the Site, you may
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          and effect while you use the Site. WITHOUT LIMITING ANY OTHER
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          right to modify or discontinue all or part of the Marketplace
          Offerings without notice at any time. We will not be liable to you or
          ...
          guarantee the Site and the Marketplace Offerings will be available at
        ...
        <p className="first-letter:text-3xl text-left">
          19. DISPUTE RESOLUTION Binding Arbitration If the Parties are unable
          ...
          on the award entered by the arbitrator. If for any reason, a Dispute
          ...
          Jackson, Illinois, and the Parties hereby consent to, and waive all
          ...
          the Site be commenced more than one (1) years after the cause of
          ...
          of the general public or any other persons. Exceptions to Arbitration
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          the Marketplace Offerings, including descriptions, pricing,
          availability, and various other information. We reserve the right to
          correct any errors, inaccuracies, or omissions and to change or update
          the information on the Site at any time, without prior notice.{" "}
        </p>
        <p className="first-letter:text-3xl text-left">
          21. DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE
          BASIS. YOU AGREE THAT YOUR USE OF THE SITE SERVICES WILL BE AT YOUR
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          ALL TIMES BE LIMITED TO $500.00 USD. CERTAIN US STATE LAWS AND
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          arising out of: (1) use of the Site; (2) breach of these Terms of Use;
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          Site for the purpose of managing the performance of the Site, as well
          as data relating to your use of the Site. Although we perform regular
        ...
        <p className="first-letter:text-3xl text-left">
          ...
          of Use operate to the fullest extent permissible by law. We may assign
        ...
        <p className="first-letter:text-3xl text-left">
          28. CONTACT US In order to resolve a complaint regarding the Site or
