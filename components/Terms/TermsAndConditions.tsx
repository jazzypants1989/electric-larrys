export default function TermsAndConditions() {
  return (
    <>
      <h2 className="text-center text-3xl font-bold text-orange drop-shadow">
        Terms And Conditions
      </h2>
      Last updated November 10, 2022
      <ol className="flex flex-col items-center justify-center">
        TABLE OF CONTENTS
        <li className="text-left">1. AGREEMENT TO TERMS</li>
        <li className="">2. INTELLECTUAL PROPERTY RIGHTS </li>
        ...
        <li>12. SUBMISSIONS </li>
        <li>13. THIRD-PARTY WEBSITE AND CONTENT </li>
        <li>14. SITE MANAGEMENT </li>
      ...
      <p className="text-left first-letter:text-3xl">
        ...
        (“you”) and Electric Larry&apos;s (&quot;Company&quot;, “we”, “us”, or
        ...
        registered in Illinois, United States and have our registered office at
        217 W. Main Street, Carbondale,, IL 62901. You agree that by accessing
      ...
      <p className="text-left first-letter:text-3xl">
        2. INTELLECTUAL PROPERTY RIGHTS Unless otherwise indicated, the Site is
      ...
      <p className="text-left first-letter:text-3xl">
        3. USER REPRESENTATIONS By using the Site, you represent and warrant
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        4. USER REGISTRATION You may be required to register with the Site. You
      ...
      <p className="text-left first-letter:text-3xl">
        5. PRODUCTS We make every effort to display as accurately as possible
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        6. PURCHASES AND PAYMENT We accept the following forms of payment: -
        Visa - Mastercard - Discover - American Express You agree to provide
        current, complete, and accurate purchase and account information for all
        purchases made via the Site. You further agree to promptly update
        ...
        time. All payments shall be in U.S. dollars. You agree to pay all
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        7. RETURN POLICY All sales are final and no refund will be issued.{" "}
      </p>
      <p className="text-left first-letter:text-3xl">
        8. PROHIBITED ACTIVITIES You may not access or use the Site for any
        ...
        that are specifically endorsed or approved by us. As a user of the Site,
        ...
        with any applicable laws or regulations. Engage in unauthorized framing
        of or linking to the Site. Upload or transmit (or attempt to upload or
        ...
        of the Site. Engage in any automated use of the system, such as using
        ...
        providing any portion of the Site to you. Attempt to bypass any measures
        of the Site designed to prevent or restrict access to the Site, or any
        portion of the Site. Copy or adapt the Site’s software, including but
        not limited to Flash, PHP, HTML, JavaScript, or other code. Except as
        ...
        a part of the Site. Except as may be the result of standard search
        ...
        or under false pretenses. Use the Site as part of any effort to compete
        ...
        advertise or offer to sell goods and services. Sell or otherwise
        transfer your profile.{" "}
      </p>
      <p className="text-left first-letter:text-3xl">
        9. USER GENERATED CONTRIBUTIONS The Site does not offer users to submit
        or post content. We may provide you with the opportunity to create,
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        10. CONTRIBUTION LICENSE You and Site agree that we may access, store,
        ...
        Site, you agree that we can use and share such feedback for any purpose
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        11. SOCIAL MEDIA As part of the functionality of the Site, you may link
      ...
      <p className="text-left first-letter:text-3xl">
        12. SUBMISSIONS You acknowledge and agree that any questions, comments,
        suggestions, ideas, feedback, or other information regarding the Site or
        the Marketplace Offerings (&quot;Submissions&quot;) provided by you to
        us are non-confidential and shall become our sole property. We shall own
      ...
      <p className="text-left first-letter:text-3xl">
        13. THIRD-PARTY WEBSITES AND CONTENT The Site may contain (or you may be
        sent via the Site or the Marketplace Offerings) links to other websites
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        14. SITE MANAGEMENT We reserve the right, but not the obligation, to:
      ...
      <p className="text-left first-letter:text-3xl">
        ...
        review our Privacy Policy: http://www.electriclarrys.com/privacy. By
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        16. TERM AND TERMINATION These Terms of Use shall remain in full force
        ...
        AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE AND
        THE MARKETPLACE OFFERINGS (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        17. MODIFICATIONS AND INTERRUPTIONS We reserve the right to change,
        ...
        or discontinue all or part of the Marketplace Offerings without notice
        at any time. We will not be liable to you or any third party for any
        modification, price change, suspension, or discontinuance of the Site or
        the Marketplace Offerings. We cannot guarantee the Site and the
        Marketplace Offerings will be available at all times. We may experience
        ...
        otherwise modify the Site or the Marketplace Offerings at any time or
        ...
        your inability to access or use the Site or the Marketplace Offerings
        during any downtime or discontinuance of the Site or the Marketplace
        Offerings. Nothing in these Terms of Use will be construed to obligate
        us to maintain and support the Site or the Marketplace Offerings or to
        supply any corrections, updates, or releases in connection therewith.{" "}
      </p>
      <p className="text-left first-letter:text-3xl">
        18. GOVERNING LAW These Terms of Use and your use of the Site and the
        Marketplace Offerings are governed by and construed in accordance with
        the laws of the State of Illinois applicable to agreements made and to
        be entirely performed within the State of Illinois, without regard to
        its conflict of law principles.{" "}
      </p>
      <p className="text-left first-letter:text-3xl">
        19. DISPUTE RESOLUTION Binding Arbitration If the Parties are unable to
        ...
        in Jackson, Illinois. Except as otherwise provided herein, the Parties
        ...
        award entered by the arbitrator. If for any reason, a Dispute proceeds
        in court rather than arbitration, the Dispute shall be commenced or
        prosecuted in the state and federal courts located in Jackson, Illinois,
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        20. CORRECTIONS There may be information on the Site that contains
      ...
      <p className="text-left first-letter:text-3xl">
        21. DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS.
        ...
        TO THIS SITE AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY
      ...
      <p className="text-left first-letter:text-3xl">
        22. LIMITATIONS OF LIABILITY IN NO EVENT WILL WE OR OUR DIRECTORS,
        ...
        TO $500.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO NOT
      ...
      <p className="text-left first-letter:text-3xl">
        25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the
      ...
      <p className="text-left first-letter:text-3xl">
        26. CALIFORNIA USERS AND RESIDENTS If any complaint with us is not
      ...
      <p className="text-left first-letter:text-3xl">
        {" "}
        27. MISCELLANEOUS These Terms of Use and any policies or operating rules
      ...
      <p className="text-left first-letter:text-3xl">
        28. CONTACT US In order to resolve a complaint regarding the Site or to
