          ...
          {loading ? (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p className="absolute -translate-y-16 translate-x-16 text-xl text-blue">
                  $
                </p>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <p className="absolute translate-x-72 translate-y-28 pl-4 text-3xl text-Red">
                  $
                </p>
                <input
                  type="text"
